...
public class TestCases
{
   ...
   public void testSimpleIf3()
   {
      ...
      assertEquals(3.0, SimpleIf.max(3.0, 1.5), DELTA); 
   }
   ...
   public void testSimpleArray3()
   {
      ...
      assertArrayEquals(
          new int[] {25,36},
          SimpleArray.squareAll(new int[] {5,6}));
   }
   ...
   public void testSimpleList2()
   {
      ...
      /* TO DO: Add a new test case. */
     List<Integer> input = 
        new LinkedList<Integer>(Arrays.asList(new Integer[] {6, 9}));
     List<Integer> expected =
        new ArrayList<Integer>(Arrays.asList(new Integer[] {36, 81}));
   ...
   public void testExampleMap2()
   {
      ...
      List<String> expected = Arrays.asList("Ajay", "Patel");
      Map<String, List<Course>> courseListsByStudent = new HashMap<>();

      courseListsByStudent.put("Ajay",
         Arrays.asList(
            new Course("CPE 203", 4),
            new Course("DATA 301", 4),
            new Course("STAT 323", 4),
            new Course("STAT 330", 4),
            new Course("ASCI 112", 4)));
      courseListsByStudent.put("Student",
         Arrays.asList(
            new Course("CPE 202", 4),
            new Course("STAT 331", 4),
            new Course("STAT 305", 4),
            new Course("MATH 248", 4)));
      courseListsByStudent.put("Patel",
         Arrays.asList(
            new Course("CPE 101", 4),
            new Course("ENGL 148", 4),
            new Course("STAT 302", 4),
            new Course("MATH 206", 4),
            new Course("CPE 572", 4)));
