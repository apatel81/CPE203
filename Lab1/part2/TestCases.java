...
public class TestCases
{
   ...
   public void testGetX()
   {
      ...
      assertEquals(3.5, new Point(3.5, 6.7).getX(), DELTA);
   }
   @Test
   public void testGetY()
   {
      assertEquals(2.0, new Point(3.5, 2.0).getY(), DELTA);
      assertEquals(3.2, new Point(7.6, 3.2).getY(), DELTA);
   }
   @Test
   ...
   {
      assertEquals(-3.0, new Point(1.0, 3.0).rotate90().getX(), DELTA);
      assertEquals(1.0, new Point(1.0, 3.0).rotate90().getY(), DELTA);
   }
